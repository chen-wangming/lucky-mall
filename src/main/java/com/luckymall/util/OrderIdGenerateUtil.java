...
import com.luckymall.service.impl.OrderServiceImpl;
...
public class OrderIdGenerateUtil {
     ...
     * 雪花id生成工具
     */
    private static SnowflakeIdUtils snowflakeIdUtils = new SnowflakeIdUtils(3, 1);

    /**
     * 方法说明：获取订单号
     *
     * @return java.lang.Long   订单号
     */
...
class SnowflakeIdUtils {
    ...
    public synchronized long nextId() {
        ...
        //如果是同一时间生成的，则进行毫秒内序列。否则，时间戳改变，毫秒内序列重置
    ...
    public static void main(String[] args) {
        ...
        LOGGER.info("雪花id生成测试：{}",idWorker.nextId());
    }
}
